...
static void logger_file_write_row(FILE *file) {
  ...
  fprintf(file, "%f,%f,%f,%f,%f,%f,%f,%f,%f", ned_to_body_rmat->m[0],ned_to_body_rmat->m[1],ned_to_body_rmat->m[2],ned_to_body_rmat->m[3],ned_to_body_rmat->m[4],ned_to_body_rmat->m[5],ned_to_body_rmat->m[6],ned_to_body_rmat->m[7],ned_to_body_rmat->m[8]);
